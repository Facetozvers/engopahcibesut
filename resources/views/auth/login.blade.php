...
<html lang="en">
  <head>
    ...
    <title>Login | E-NGOPAHCIBESUT</title>
          ...
          <form method="POST" action="{{ route('login') }}">
            ...
            <div class="row justify-content-center">
              <div class="col-md-12 pt-5 text-center">
                <button class="form=control btn btn-success w-100 py-3" type="submit" style="text-align:center; margin:auto">Login</button>
              </div>
            </div>
          </form>
          <div class="row py-3">
            <p class="text-center">Belum punya akun? <a href="/register" style="text-decoration:none;color:green">Daftar</a></p>
          </div>
        </div>
      </div>
