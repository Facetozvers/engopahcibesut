...
@section('title', 'Pesananku | E-NGOPAHCIBESUT')
@section('content')
    <h3 class="panel-header">Pesananku</h3>
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            <div class="list-container p-3">
                <h3 class="list-item text-center"><i class="fas fa-exclamation-triangle me-3"></i>Maaf, Pesanan Tidak Ditemukan!</h3>
            </div>
        </div>
        @endif
            ...
            <div class="modal-body">
                ...
                <table>
                    <tr class="pb-2">
                        ...
                        <td id="reqidModal">#239280931209</td>
                    </tr>
                    <tr>
                        <td>Nama</td>
                        <td style="padding-right :10px">:</td>
                        <td id="namaModal">Rafi Chandra</td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td style="padding-right :10px">:</td>
                        <td id="alamatModal">Komp. TNI AU CURUG INDAH, Jl. Wirajasa No.9 RT01/RW08as dfas df asdfsadfas dfas asdfasd </td>
                    </tr>
                    <tr>
                        <td>Tanggal Request</td>
                        <td style="padding-right :10px">:</td>
                        <td id="reqModal">Rafi Chandra</td>
                    </tr>
                    <tr>
                        <td>Pengambilan</td>
                        <td style="padding-right :10px">:</td>
                        <td id="pengambilanModal">Rafi Chandra</td>
                    </tr>
                    <tr>
                        <td>Status</td>
                        <td style="padding-right :10px">:</td>
