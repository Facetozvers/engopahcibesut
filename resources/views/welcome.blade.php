...
@section('content')
<div class="container-fluid" style="height:600px; background:#13ae4b">
...
<div class="container mt-5">
    <h2 class="section-header text-center">Tentang E-NGOPAHCIBESUT</h2>
    ...
    <div class="row mt-5 mb-4 px-5 justify-content-center">
...
<div class="container-fluid mt-5 px-5 bg-light">
        ...
        <h2 class="page-header text-center pt-5">Cara Kerja E-NGOPAHCIBESUT</h2>
